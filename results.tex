...
time step. The dimensional variables $x$, $y$, $t$, $C$,
and $\phi$ are used to present the solutions.
...
This is illustrated for HP\_ANISO adaptivity mode in Fig.~\ref{fig:singlemultidof}, Fig.~\ref{fig:singlemulticpu} and Fig.~\ref{fig:singlemultierror}.
The same holds true for HP\_ISO mode. 
...
\end{figure}
\noindent 
Fig. \ref{fig:poly} shows higher-order meshes in the adaptive multi-mesh $hp$-FEM
...
is much greater than the voltage gradient. Therefore the multi-mesh $hp$-FEM adaptivity 
