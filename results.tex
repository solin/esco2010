...
and Fig.~\ref{fig:singlemulticpu}. Notice that the HP\_ISO with the single-mesh
configuratio did not even converge in terms of number of degrees of freedom --- the
adaptivity resulted in an unreasonable problem size and the calculation was
not finished.
